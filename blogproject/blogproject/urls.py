...
urlpatterns = [
    ...
    path('layout-static/<str:page_name>/', views.layout_static_page_name, name='layout_static_page_name'),
    path('login/<str:page_name>/', views.layout_static_page_name, name='layout_static_login_name'),
]
